    ...
    return (
        <>
            ...
            <div className="contact-page">
                ...
                <div className="card-content contact-information text-blue700">
                    <hr className="hairline-card border-blue700 " />

                    <div className="flex flex-row items-center">
                        <svg class="w-6 h-6 m-2 text-blue700" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-row items-center text-blue700">
                        ...
                        <p>EDVschulung@Ruediger-Bayer.de</p>
                    </div>
                ...
                <form
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6 py-2">
                        <div class="w-full px-3">
                            ...
                            <textarea
                                class="boxshadowTop no-resize appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48 resize-none"
                                id="message"
                                name="message"
                            >
                            </textarea>
